...
export const defaultData: SiteData = {
  ...
  skills: [
    { name: "Python", icon: "python", category: "backend", level: 85 },
    { name: "HTML", icon: "html", category: "frontend", level: 95 },
    { name: "CSS", icon: "css", category: "frontend", level: 90 },
    { name: "JavaScript", icon: "javascript", category: "frontend", level: 80 },
    { name: "Node.js", icon: "nodejs", category: "backend", level: 75 },
    { name: "Responsive Design", icon: "responsive", category: "frontend", level: 88 },
    { name: "Cyber Security", icon: "security", category: "security", level: 70 },
    { name: "Networking", icon: "network", category: "security", level: 65 },
    { name: "Linux", icon: "linux", category: "other", level: 72 },
    { name: "Premiere Pro", icon: "premiere", category: "design", level: 78 },
    { name: "Affinity Designer", icon: "affinity", category: "design", level: 70 },
    { name: "English", icon: "language", category: "other", level: 90 },
  ],
  experience: [
    {
      id: "1",
